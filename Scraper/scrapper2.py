...
browser=webdriver.Edge("C:\Users\biana\Downloads\msedgedriver.exe")
    ...
    for i in range(1,5):
        while True:
            ...
            if current_page_num < i:
                browser.find_element(By.XPATH,value='//*[@id="results"]/ul[2]/li[1]/a').click()
            elif current_page_num > i:
                browser.find_element(By.XPATH,value='//*[@id="results"]/ul[26]/li[1]/a').click()
            else:
                break
